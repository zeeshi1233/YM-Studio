...
export const Navbar: React.FC<NavbarProps> = ({ onOpenBooking, onOpenConsultation }) => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 flex items-center justify-between gap-3 lg:gap-4 xl:gap-8">
        {/* Brand Logo */}
        ...
        <nav className="hidden lg:flex items-center justify-center gap-1.5 lg:gap-2.5 xl:gap-5 2xl:gap-7 flex-1 min-w-0 max-w-4xl mx-auto">
          <button
            onClick={() => scrollToSection('services-section')}
            className={`whitespace-nowrap px-2 xl:px-2.5 py-1 text-xs xl:text-sm font-medium transition-colors cursor-pointer relative group ${
          ...
          <button
            ...
            className={`whitespace-nowrap px-2 xl:px-2.5 py-1 text-xs xl:text-sm font-medium transition-colors cursor-pointer relative group ${
              activeSection === 'skin-treatments-section'
                ? 'text-[#1FD1B2] font-semibold'
                : 'text-slate-300 hover:text-[#1FD1B2]'
            }`}
            id="nav-link-skin"
          ...
          <button
            ...
            className={`whitespace-nowrap px-2 xl:px-2.5 py-1 text-xs xl:text-sm font-medium transition-colors cursor-pointer relative group ${
              activeSection === 'hair-styling-section'
                ? 'text-[#1FD1B2] font-semibold'
                : 'text-slate-300 hover:text-[#1FD1B2]'
            }`}
            id="nav-link-hair"
          ...
          <button
            ...
            className={`whitespace-nowrap px-2 xl:px-2.5 py-1 text-xs xl:text-sm font-medium transition-colors cursor-pointer flex items-center gap-1.5 relative group ${
              activeSection === 'academy-section'
          ...
          >
            ...
            <span>Academy</span>
            <span
              className={`absolute bottom-0 left-0 h-0.5 bg-[#B829A0] transition-all duration-300 rounded-full ${
                activeSection === 'academy-section'
          ...
          <button
            ...
            className={`whitespace-nowrap px-2 xl:px-2.5 py-1 text-xs xl:text-sm font-medium transition-colors cursor-pointer relative group ${
              activeSection === 'quote-calculator-section'
                ? 'text-[#1FD1B2] font-semibold'
                : 'text-slate-300 hover:text-[#1FD1B2]'
            }`}
        ...
        {/* Action Controls */}
        <div className="hidden sm:flex items-center gap-2 lg:gap-2.5 xl:gap-3.5 flex-shrink-0">
          <button
            onClick={onOpenConsultation}
            className="whitespace-nowrap px-3 xl:px-4 py-2 rounded-full text-xs font-semibold text-[#1FD1B2] bg-[#1FD1B2]/5 border border-[#1FD1B2]/40 hover:border-[#1FD1B2] hover:bg-[#1FD1B2]/15 hover:shadow-[0_0_20px_rgba(31,209,178,0.25)] transition-all duration-300 cursor-pointer"
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <button
            onClick={() => onOpenBooking()}
            className="px-3 py-1.5 rounded-full text-xs font-bold text-white bg-gradient-to-r from-[#B829A0] to-[#1FD1B2] shadow-sm cursor-pointer sm:hidden"
